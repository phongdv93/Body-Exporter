...
_SITE_CONTENT_ALTER = [
    ...
    ("buy_title", "VARCHAR(200) DEFAULT ''"),
    ("buy_title_en", "VARCHAR(200) DEFAULT ''"),
    ("buy_intro_en", "TEXT DEFAULT ''"),
    ("buy_form_note", "TEXT DEFAULT ''"),
    ("buy_form_note_en", "TEXT DEFAULT ''"),
    ("buy_payment_note", "TEXT DEFAULT ''"),
    ("buy_payment_note_en", "TEXT DEFAULT ''"),
    ("buy_footer_en", "TEXT DEFAULT ''"),
    ("buy_success_title", "VARCHAR(200) DEFAULT ''"),
    ("buy_success_title_en", "VARCHAR(200) DEFAULT ''"),
    ("buy_success_html", "TEXT DEFAULT ''"),
    ("buy_success_html_en", "TEXT DEFAULT ''"),
    ("download_notes_en", "TEXT DEFAULT ''"),
    ("download_intro", "TEXT DEFAULT ''"),
    ("download_intro_en", "TEXT DEFAULT ''"),
    ("download_policy_html", "TEXT DEFAULT ''"),
