...
class SiteContent(Base):
    ...
    download_notes_en: Mapped[str] = mapped_column(Text, default="")
    download_intro: Mapped[str] = mapped_column(Text, default="")
    download_intro_en: Mapped[str] = mapped_column(Text, default="")
    download_policy_html: Mapped[str] = mapped_column(Text, default="")
    download_policy_html_en: Mapped[str] = mapped_column(Text, default="")
    download_guides_html: Mapped[str] = mapped_column(Text, default="")
    download_guides_html_en: Mapped[str] = mapped_column(Text, default="")
    buy_title: Mapped[str] = mapped_column(String(200), default="")
    buy_title_en: Mapped[str] = mapped_column(String(200), default="")
    buy_intro: Mapped[str] = mapped_column(Text, default="")
    buy_intro_en: Mapped[str] = mapped_column(Text, default="")
    buy_form_note: Mapped[str] = mapped_column(Text, default="")
    buy_form_note_en: Mapped[str] = mapped_column(Text, default="")
    buy_payment_note: Mapped[str] = mapped_column(Text, default="")
    buy_payment_note_en: Mapped[str] = mapped_column(Text, default="")
    buy_footer: Mapped[str] = mapped_column(Text, default="")
    buy_footer_en: Mapped[str] = mapped_column(Text, default="")
    buy_success_title: Mapped[str] = mapped_column(String(200), default="")
    buy_success_title_en: Mapped[str] = mapped_column(String(200), default="")
    buy_success_html: Mapped[str] = mapped_column(Text, default="")
    buy_success_html_en: Mapped[str] = mapped_column(Text, default="")
