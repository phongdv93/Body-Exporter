...
MESSAGES = {
    ...
    "buy.btn_pay": "Pay",
    "buy.years_label": "License years",
    "buy.years_hint": "Choose 1–{max} years (price × years).",
    "buy.order_summary": "Order summary",
    "buy.modal_total": "Total",
    "buy.modal_years_count": "years",
    "buy.add_discount": "Add discount",
    "buy.discount_placeholder": "Discount code",
    "buy.discount_apply": "Apply",
    "buy.discount_invalid": "Invalid discount code.",
    "buy.discount_amount_zero": "This code is 100% off — QR amount cannot be zero. Use at most 99%.",
    "buy.pricing_per_year": "per year",
    "buy.per_year": "year",
