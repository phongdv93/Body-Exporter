...
MESSAGES = {
    ...
    "buy.btn_pay": "Thanh toán",
    "buy.years_label": "Số năm license",
    "buy.years_hint": "Chọn 1–{max} năm (giá × số năm).",
    "buy.order_summary": "Tóm tắt đơn hàng",
    "buy.modal_total": "Tổng",
    "buy.modal_years_count": "năm",
    "buy.add_discount": "Thêm mã giảm giá",
    "buy.discount_placeholder": "Mã giảm giá",
    "buy.discount_apply": "Áp dụng",
    "buy.discount_invalid": "Mã giảm giá không hợp lệ.",
    "buy.discount_amount_zero": "Mã này giảm 100% — không tạo được QR. Dùng tối đa 99%.",
    "buy.pricing_per_year": "mỗi năm",
    "buy.per_year": "năm",
